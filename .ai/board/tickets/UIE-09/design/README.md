# UIE-09 — the visual reference. It is a TRANSCRIPTION, NOT AN IMAGE, and most of what it shows is NOT this ticket

**The half of the picture this ticket answers is the top bar's right cluster** — specifically the
**outline pill with no caret**, transcribed below as `Quản trị & Duyệt`, and the single address
behind it. Everything else described below belongs to `UIE-10`, to a deferred decision, or to
nothing.
...
`.ai/board/tickets/UIE-10/design/README.md` — because one picture was cut into two tickets, and a
